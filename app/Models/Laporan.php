...
class Laporan extends Model
{
    ...
    private static $kategoriKataKunci = [
        ...
        'Pendidikan dan Kebudayaan' => ['pendidikan','sekolah','guru','murid','sekolah inklusif','kebudayaan','olahraga','universitas','pelajaran','beasiswa','buku','modul','tenaga pendidikan','ujian','jambore','pramuka','ijazah','kurikulum','prestasi siswa','prestasi guru','dosen','penerimaan siswa baru','pemagangan','zonasi', 's1', 'kuliah', 'ukt', 'renovasi', 'bbh'],
        ...
        'Luar Negeri' => ['imigran', 'kekonsuleran', 'pengungsi', 'migran', 'deportan', 'pencari suaka', 'tppo', 'paspor', 'wna', 'tkw', 'tki'],
