...
class Laporan extends Model
{
    ...
    private static $kategoriKataKunci = [
        ...
        'Ekonomi dan Keuangan' => ['ekonomi', 'keuangan', 'uang', 'investasi', 'bank', 'pinjaman', 'kredit', 'tabungan', 'inflasi', 'pinjol', 'utang', 'modal usaha', 'hutang', 'bodong', 'dana', 'asuransi', 'online', 'pajak', 'modal', 'penjaminan', 'pailit', 'angsuran', 'ojk', 'rentenir', 'tagihan'],
        'Kesehatan' => ['kesehatan', 'fasilitas dan pelayanan kesehatan', 'dokter', 'puskesmas', 'obat', 'penyakit', 'vaksin', 'bpjs kesehatan', 'perawat', 'stunting', 'rumah sakit', 'organisasi profesi tenaga kesehatan', 'malpraktek', 'pasien', 'sehat', 'sakit', 'stunting', 'gizi', 'rsud', 'persalinan'],
        ...
        'Pekerjaan Umum dan Penataan Ruang' => ['pekerjaan umum', 'infrastruktur', 'jalan','jembatan','bangunan','penataan ruang','pemukiman','gedung','rtrw','bendungan','sertifikat','tanah','shm','rumah','perkebunan','irigasi','ajb','ptsl','hgb','hgu','tora','agraria','shp','sertifikat','psn','mbr','rusun','apartemen','adat','sewa', 'jalan rusak', 'fasilitas umum'],
        ...
        'Pendidikan dan Kebudayaan' => ['pendidikan','sekolah','guru','murid','sekolah inklusif','kebudayaan','olahraga','universitas','pelajaran','beasiswa','buku','modul','tenaga pendidikan','ujian','jambore','pramuka','ijazah','kurikulum','prestasi siswa','prestasi guru','dosen','penerimaan siswa baru','pemagangan','zonasi', 's1', 'kuliah', 'ukt', 'renovasi', 'bbh', 'kip'],
        ...
        'Ketenagakerjaan' => ['pekerja','migran','tenaga kerja','buruh','karyawan','phk','upah','gaji','tunjangan','pensiun','jaminan kerja','outsourcing','hubungan industrial','kesempatan kerja','cuti','bpjs ketenagakerjaan','serikat pekerja','lowongan','pengangguran','pecat', 'kerja', 'rekrutmen', 'recruitment'],
        ...
        'Luar Negeri' => ['imigran', 'kekonsuleran', 'pengungsi', 'migran', 'deportan', 'pencari suaka', 'tppo', 'paspor', 'wna', 'tkw', 'tki', 'imigrasi'],
